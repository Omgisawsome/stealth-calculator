Stealth Calculator- A Casio calculator with a Raspberry Pi put inside!
...
Just order all the parts on my BOM, and also order the PCB files. Unscrew open the calculator, and you will be able to lift off the board and the attached screen.
